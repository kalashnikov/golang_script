...
type TestMessage_MsgItem struct {
	...
	Thumbnail        *string `protobuf:"bytes,3,req,name=thumbnail" json:"thumbnail,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (m *TestMessage_MsgItem) GetName() string {
	if m != nil && m.Name != nil {
		return *m.Name
	}
	return ""
...
func (m *TestMessage_MsgItem) GetThumbnail() string {
